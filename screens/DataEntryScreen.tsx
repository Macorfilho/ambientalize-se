...
export default function DataEntryScreen({ navigation }: DataEntryScreenProps) {
  ...
  const saveData = async () => {
    ...
    try {
      ...
      // Após salvar, você pode decidir para onde ir.
      // Mantendo a navegação para RiskVisualizationScreen como no seu AppNavigator original
    ...
    >
      <SafeAreaView style={styles.content}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {/* Botão para Ver Histórico com novo estilo */}
          <View style={styles.navigationButtonsContainer}>
            <TouchableOpacity
              style={styles.historyButton} // Usando o novo estilo aqui
              onPress={() => navigation.navigate('History')}
            >
              <Text style={styles.historyButtonText}>Ver Histórico</Text> {/* Usando o novo estilo de texto aqui */}
            </TouchableOpacity>
          </View>
        </ScrollView>
      </SafeAreaView>
...
const styles = StyleSheet.create({
    ...
    // Novos estilos para o botão de histórico, copiados de RiskVisualizationScreen
    historyButton: {
        ...
        shadowOpacity: 0.2,
        shadowRadius: 3,
        marginBottom: 12, // Mantém o espaçamento se houver mais de um botão secundário
    },
    historyButtonText: {
        color: '#FFFFFF',
        fontSize: 17,
    ...
    // O estilo buttonSecondary antigo pode ser removido se não for mais usado
    buttonSecondary: {
        backgroundColor: '#6A5ACD', // SlateBlue
        paddingVertical: 16,
